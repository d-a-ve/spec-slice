...
import { CopyBar } from './features/extractor/CopyBar'
import { EndpointDetail } from './features/extractor/EndpointDetail'
import { EndpointList } from './features/extractor/EndpointList'
import { ProjectList } from './features/extractor/ProjectList'
import { SpecLoader } from './features/extractor/SpecLoader'
import { useProject } from './features/extractor/useProject'
  ...
  return (
    <div className="flex h-svh min-h-0 flex-col bg-[var(--bg)] text-[var(--ink)]">
      <header className="flex items-center justify-between border-b border-[var(--line)] px-4 py-3">
        <span className="font-[family-name:var(--display)] text-xl tracking-tight text-[var(--ink)]">
          Spec Slice
        </span>
        {session.toast ? (
